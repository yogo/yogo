...
begin
  ...
  User.create(:login => "ray.ford",          :email => "raymond.ford@umontana.edu",       :first_name => "Ray",      :last_name => "Ford",       :password => "fordr",      :password_confirmation => "fordr",        :system_role => user_role)
