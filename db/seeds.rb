...
begin
  ...
  User.create(:login => "alice.jones",       :email => "alice.jones@eku.edu",               :first_name => "Alice",    :last_name => "Jones",      :password => "jonesa",     :password_confirmation => "jonesa")
  ...
  User.create(:login => "barbara.kucera",    :email => "bakuce2@uky.edu",                   :first_name => "Barbara",  :last_name => "Kucera",     :password => "kucerab",    :password_confirmation => "kucerab")
  User.create(:login => "bill.ford",         :email => "wiford2@uky.edu",                   :first_name => "Bill",     :last_name => "Ford",       :password => "fordb",      :password_confirmation => "fordb")
  ...
  User.create(:login => "bob.madsen",        :email => "bmadsen@cdkc.edu",                  :first_name => "Bob",      :last_name => "Madsen",     :password => "madsenb",    :password_confirmation => "madsenb")
  ...
  User.create(:login => "cindy.harnett",     :email => "cindy.harnett@louisville.edu",      :first_name => "Cindy",    :last_name => "Harnett",    :password => "harnettc",   :password_confirmation => "harnettc")
  ...
  User.create(:login => "debra.earl",        :email => "debra.earl@montana.edu",            :first_name => "Debra",    :last_name => "Earl",       :password => "earld",      :password_confirmation => "earld")
  User.create(:login => "denise.barnes",     :email => "dbarnes@nsf.gov",                   :first_name => "Denise",   :last_name => "Barnes",     :password => "barnesd",    :password_confirmation => "barnesd")
  ...
  User.create(:login => "don.schenck",       :email => "don.schenck@umontana.edu",          :first_name => "Don",      :last_name => "Schenck",    :password => "schenckd",   :password_confirmation => "schenckd")
  User.create(:login => "ellie.zignego",     :email => "ezignego@gmail.com",                :first_name => "Ellie",    :last_name => "Zignego",    :password => "zignegoe",   :password_confirmation => "zignegoe")
  ...
  User.create(:login => "gordon.luikart",    :email => "gordon.luikart@umontana.edu",       :first_name => "Gordon",   :last_name => "Luikart",    :password => "luikartg",   :password_confirmation => "luikartg")
  ...
  User.create(:login => "james.irvine",      :email => "irvine@yellowstoneresearch.org",    :first_name => "James",    :last_name => "Irvine",     :password => "irvinej",    :password_confirmation => "irvinej")
  ...
  User.create(:login => "jim.fox",           :email => "jffox2@uky.edu",                    :first_name => "Jim",      :last_name => "Fox",        :password => "foxj",       :password_confirmation => "foxj")
  User.create(:login => "jim.griffioen",     :email => "griff@uky.edu",                     :first_name => "Jim",      :last_name => "Griffioen",  :password => "griffioenj", :password_confirmation => "griffioenj")
  User.create(:login => "jim.myers",         :email => "jimmyers@ncsa.uiuc.edu",            :first_name => "Jim",      :last_name => "Myers",      :password => "myersj",     :password_confirmation => "myersj")
  ...
  User.create(:login => "john.lucotch",      :email => "john.lucotch@umontana.edu",         :first_name => "John",     :last_name => "Lucotch",    :password => "lucotchj",   :password_confirmation => "lucotchj")
  User.create(:login => "julia.melkers",     :email => "julia.melkers@pubpolicy.gatech.edu",:first_name => "Julia",    :last_name => "Melkers",    :password => "melkersj",   :password_confirmation => "melkersj")
  ...
  User.create(:login => "matt.williamson",   :email => "mattew.williamson@murraystate.edu", :first_name => "Matt",     :last_name => "Williamson", :password => "williamsonm",:password_confirmation => "williamsonm")
  User.create(:login => "maury.valett",      :email => "maury.valett@umontana.edu",         :first_name => "Maury",    :last_name => "Valett",     :password => "valettm",    :password_confirmation => "valettm")
  User.create(:login => "mike.mckay",        :email => "mmckay@bfcc.org",                   :first_name => "Mike",     :last_name => "McKay",      :password => "mckaym",     :password_confirmation => "mckaym")
  User.create(:login => "nathan.jacobs",     :email => "jacobsn@gmail.com",                 :first_name => "Nathan",   :last_name => "Jacobs",     :password => "jacobsn",    :password_confirmation => "jacobsn")
  ...
  User.create(:login => "robert.stewad",     :email => "rlst223@gmail.com",                 :first_name => "Robert",   :last_name => "Stewad",     :password => "stewadr",    :password_confirmation => "stewadr")
  User.create(:login => "scott.frazier",     :email => "frazier@yellowstoneresearch.org",   :first_name => "Scott",    :last_name => "Frazier",    :password => "fraziers",   :password_confirmation => "fraziers")
  ...
  User.create(:login => "shandin.pete",      :email => "shandinp@yahoo.com",                :first_name => "Shandin",  :last_name => "Pete",       :password => "petes",      :password_confirmation => "petes")
  User.create(:login => "stephanie.jenkins", :email => "swjenk2@email.uky.edu",             :first_name => "Stephanie",:last_name => "Jenkins",    :password => "jenkins",    :password_confirmation => "jenkins")
  ...
  User.create(:login => "susan.hendricks",   :email => "susan.hendricks@murraystate.edu",   :first_name => "Susan",    :last_name => "Hendricks",  :password => "hendrickss", :password_confirmation => "hendrickss")
  User.create(:login => "terry.mclaren",     :email => "tmclaren@ncsa.illinois.edu",        :first_name => "Terry",    :last_name => "McLaren",    :password => "mclarent",   :password_confirmation => "mclarent")
  User.create(:login => "tom.bansak",        :email => "tom.bansak@flbs.umt.edu",           :first_name => "Tom",      :last_name => "Bansak",     :password => "bansakt",    :password_confirmation => "bansakt")
