...
begin
  ...
  User.create(:login => "julie.melkers",     :email => "julia.melkers@pubpolicy.gatech.edu",:first_name => "Julie",    :last_name => "Melkers",    :password => "melkersj",   :password_confirmation => "melkersj")
  User.create(:login => "kathryn.watson",    :email => "klwatson@montana.edu",              :first_name => "Kathryn",  :last_name => "Watson",     :password => "watsonk",    :password_confirmation => "watsonk")
