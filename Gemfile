...
gem "rake"                 
gem "dm-core",              "0.10.2"
gem "dm-reflection",        "0.0.2",:git => "git://github.com/robbielamb/dm-reflection.git" # :path => "vendor/gems/dm-reflection-0.0.1"
gem "dm-timestamps"  
gem "dm-validations"
...
gem "dm-persevere-adapter", "0.48.1", :require_as => 'dm-core'
